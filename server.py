...
def create_license():
    ...
    # Lifetime
    if (duration_value is None and duration_unit is None and duration_days is None):
        expires_str = None
    else:
        try:
